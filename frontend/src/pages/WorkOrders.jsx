...
import { Filter, Plus, Inbox } from "lucide-react";
...
// ---------------------------------------------------------------------------
// Skeleton — réplica fiel de la forma de una TaskCard
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Columna individual — acepta isLoading
// ---------------------------------------------------------------------------
function WorkOrderColumn({ id, label, accentColor, tasks, isLoading }) {
  return (
    ...
    >
      ...
      {/* Contenido: skeletons o tarjetas reales */}
...
export default function WorkOrders() {
  ...
  // Cambia a `true` para ver el empty state cuando no hay órdenes
  const isEmpty = false;
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 md:grid-cols-3">
        {!isLoading && isEmpty ? (
          /* ── Empty State — abarca las 3 columnas ── */
          <KanbanEmptyState />
        ) : (
          /* ── Columnas con tarjetas reales o skeletons ── */
          COLUMNS.map((col) => (
            <WorkOrderColumn
              key={col.id}
              {...col}
